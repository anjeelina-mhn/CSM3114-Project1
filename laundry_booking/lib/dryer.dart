...
class Dryer extends StatefulWidget {
  @override
  _DryerState createState() => _DryerState();
}
      ...
      body: Container(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Text(
                'Enter Date and Time for Dryer Booking',
                ...
                onPressed: () {
                  if (!_isValidDateTime()) {
                    ...
                    String confirmationMessage =
                        'Dryer booked for ${dateController.text} at ${timeController.text}';
                    Navigator.push(
                      context,
                      MaterialPageRoute(
